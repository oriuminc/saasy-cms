...
module.exports = function(BasePlugin) {
  ...
  return PartialsPlugin = (function(_super) {
    ...
    PartialsPlugin.prototype.config = {
      partialsPath: 'contents/partials'
    };
    ...
    PartialsPlugin.prototype.extendTemplateData = function(_arg) {
      ...
      templateData.include = function(type, obj) {
        if(!type || !obj) {
            return "";
        }
        return templateData.partial(type + '.html.eco', docpad.getCollection(type).findOne({relativeBase: obj}).toJSON());
      };
    ...
    PartialsPlugin.prototype.renderDocument = function(opts, next) {
      ...
      tasks = new TaskGroup().setConfig({
        ...
        opts.content = opts.content.replace(partialContainerRegex, function(match, partialId) {
          ...
          return "<div data-type='partial/" + partial.document.attributes.type + "' data-filename='" + partial.document.attributes.filename + "' class='saasy-partial'>" + partial.result + "</div>";
        });
