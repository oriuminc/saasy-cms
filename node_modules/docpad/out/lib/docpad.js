  ...
  DocPad.prototype.setConfig = function(instanceConfig, next) {
    ...
    postTasks.addTask(function(complete) {
        return _this.loadPlugins(function() {
            var plugins = [],
            key;
            for(key in _this.loadedPlugins) {
                if(_this.loadedPlugins.hasOwnProperty(key)) {
                    plugins.push(_this.loadedPlugins[key]);
                }
            }
            plugins.sort(function(a, b) { return b.priority - a.priority; });
